...
namespace DAL
{
    ...
    public partial class hlt_richiesteesterne_backup
    {
        ...
        public string sospettadiagnosi { get; set; }
        public string risonanzamagnetica { get; set; }
        public string ecografia { get; set; }
        public string mammografia { get; set; }
